...
public class Changes {
    ...
    private final List<? extends DocumentRevision> results;

    protected Changes(long lastSequence, List<? extends DocumentRevision> results) {
     ...
     */
    public List<? extends DocumentRevision> getResults() {
        return this.results;
    }
